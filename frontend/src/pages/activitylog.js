        ...
        mobileConfig: {
          ...
          child: {
            1: buildHeader({
              ...
              backgroundColor: 'transparent', divider: false, padding: '12px 8px 14px',
            }),
            2: buildGrid({
            ...
            5: Ruki.auditLogs.length > 0 ? buildTable({
              columns: [
              ...
              child: {
                1: buildText('No audit logs found for the selected criteria.', { size: 'lg', color: 'gray400', style: { padding: '80px 0', textAlign: 'center' } })
              }
            })
          }
        },
