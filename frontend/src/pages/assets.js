...
import { buildBadge, buildButton, buildContentGrid, buildDropdown, buildGrid, buildHeader, buildIcon, buildIconContainer, buildPopup, buildTable, buildText, buildTextBadge } from '../ui/index.js'
...
export function AssetsPage(user) {
  return {
    ...
    setup() {
      ...
      const triggerUpdate = () => formRef.value?.submitForm()
      const triggerDelete = () => { showDeleteConfirm.value = true }
      const confirmDelete = () => {
      ...
      return {
        ...
        notification, showDeleteConfirm, confirmDelete
      }
    },
    render(Ruki) {
